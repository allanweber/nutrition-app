        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  We may contact you about service updates, security
                  notifications, and important account information.
                </p>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-foreground mb-2">
          ...
          <section>
            ...
            <div className="space-y-6">
              <div>
                ...
                <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                  <li>
                    With third-party food databases for accurate nutritional
                    data
                  </li>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              privacy policy. You may request deletion of your account and data
              at any time.
            </p>
          </section>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  information. We will delete it within 30 days of your request.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              we become aware of such collection, we will take immediate steps
