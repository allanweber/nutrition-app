...
export default function Hero() {
  const { fadeUpSmall, fadeUp, mockupEnter, reduced } = useLandingMotion();
              ...
              <div className="col-span-12 md:col-span-8 bg-card rounded-xl p-5 border border-border/10">
                ...
                <div className="flex items-start gap-6">
                  <div className="flex-1">
                    <div className="flex items-baseline gap-2">
                      <motion.span
                        ...
                        animate={{ opacity: 1 }}
                        transition={reduced ? undefined : { delay: 1.2 }}
                  ...
                  <div
                    ...
                    role="img"
                    aria-label="440 kilocalories remaining of 2000 goal, 78 percent consumed"
                  >
                    <svg className="w-full h-full -rotate-90" viewBox="0 0 100 100" aria-hidden>
                      ...
                      <motion.circle
                        ...
                        fill="none"
                        strokeLinecap="round"
                        initial={reduced ? { strokeDasharray: '206 264' } : { strokeDasharray: '0 264' }}
                        animate={{ strokeDasharray: '206 264' }}
                        transition={reduced ? undefined : { duration: 1.5, delay: 1 }}
                      />
                    </svg>
                  ...
                  {MACROS.map((m) => (
                    <div key={m.label}>
                      ...
                      <div className="h-2 w-full rounded-full bg-secondary overflow-hidden">
                        <div
                          className={`h-full w-full origin-left rounded-full ${m.color}`}
