      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
            viewport={{ once: true }}
            className="md:col-span-8 bg-secondary rounded-[2rem] p-8 relative overflow-hidden flex flex-col justify-between group border border-border/10 min-h-[280px]"
          >
            ...
            <div className="mt-8 relative z-10 flex gap-4 overflow-x-auto pb-2">
              <div className="min-w-[140px] p-4 bg-background rounded-xl border border-border/10 flex-shrink-0">
                <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest mb-1">Sleep</p>
              ...
              <div className="min-w-[140px] p-4 bg-background rounded-xl border border-border/10 flex-shrink-0">
                <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest mb-1">Protein</p>
          ...
          >
            ...
            <div className="mt-6 p-4 bg-black/20 backdrop-blur-md rounded-xl border border-white/20">
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-xs bg-secondary text-secondary-foreground px-2 py-0.5 rounded-full font-bold">92% Match</span>
              </div>
