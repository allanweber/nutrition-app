...
0. **Save your input prompt**: before running `/speckit.specify`, write your feature description into `.specify/prompts/<id>-<slug>.md` (e.g. `.specify/prompts/003-diet-plan-management.md`). This is the authoritative record of what you asked for and allows you to reproduce or audit the SpecKit run later.
...
Key paths (SpecKit artifacts):

- Input prompts: `.specify/prompts/` — one file per feature, named `<id>-<slug>.md`
- Feature specs: `specs/<id>-<slug>/` — generated by SpecKit
