...
```
Phase 2 (Foundation)
  └─ T033 (use-food-search hook) — must precede T016 and T018
  └─ T034 (food-details link in result-item) — extends T007
  └─ Phase 3 (US1) — requires T006 (types), T007 (result-item), T008 (states), T033 (hook)
       └─ T035 (Load more UI) — requires T011 (tabs)
       └─ Phase 4 (US2) — requires T014 (FoodSearchField), T015 (modal) complete
            └─ T036 (FatSecret caching) — extends T020
            └─ T037 (FatSecret logging) — extends T020
...
- T033 (use-food-search hook) and T034 (result-item link) can run in parallel — different files
- T035 (Load more UI) can run in parallel with T012/T013/T014 — different concerns within tabs
- T036 (FatSecret caching) and T037 (FatSecret logging) can run in parallel — same file, different logic blocks
- T018 (SearchSection) can begin as soon as T014 (FoodSearchField) and T033 (hook) are complete
...
**Total tasks**: 37
**Tasks per user story**: US1 = 11 (T009–T017, T035), US2 = 6 (T018–T021, T036–T037), US3 = 4 (T022–T025), US4 = 4 (T026–T029)
**Setup/Foundation**: 8 (T001–T008, T033–T034)
**Polish**: 3 (T030–T032)
**Analysis remediation tasks**: T033, T034, T035, T036, T037 (added by /speckit.analyze)
